...
import { Flame, Check, Brain, Dumbbell, Activity, Heart, Zap, Shield, Maximize2, X, FolderInput, Trash2, Clock, Play, TrendingUp, ChevronDown, ChevronUp, Palette, Coins, Users } from 'lucide-react';
